const buttonStateOffDataEN: any = {
...
const translateButtonStateOffEN = (key: string | number, ...args: any[]) => {
    const translation = buttonStateOffDataEN[key];
    if(typeof translation === "function") return translation(args);
    else return translation;
};

module.exports = translateButtonStateOffEN;
