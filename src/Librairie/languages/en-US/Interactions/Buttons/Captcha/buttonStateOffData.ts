const buttonStateGeneralOffDataEN: any = {
...
const translateButtonStateGeneralOffEN = (key: string | number, ...args: any[]) => {
    const translation = buttonStateGeneralOffDataEN[key];
    if(typeof translation === "function") return translation(args);
    else return translation;
};

module.exports = translateButtonStateGeneralOffEN;
