...
const translateButtonStateOnEN = (key: string | number, ...args: any[]) => {
    const translation = buttonStateOnDataEN[key];
    if(typeof translation === "function") return translation(args);
    else return translation;
};

module.exports = translateButtonStateOnEN;
