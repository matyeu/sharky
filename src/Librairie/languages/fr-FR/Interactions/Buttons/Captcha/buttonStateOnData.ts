const buttonStateGeneralOnDataFR: any = {
...
const translateButtonStateGeneralOnFR = (key: string | number, ...args: any[]) => {
    const translation = buttonStateGeneralOnDataFR[key];
    if(typeof translation === "function") return translation(args);
    else return translation;
};

module.exports = translateButtonStateGeneralOnFR;
