...
const translateButtonStateOnFR = (key: string | number, ...args: any[]) => {
    const translation = buttonStateOnDataFR[key];
    if(typeof translation === "function") return translation(args);
    else return translation;
};

module.exports = translateButtonStateOnFR;
